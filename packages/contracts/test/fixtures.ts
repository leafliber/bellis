...
export const SCHEMA_FIXTURES: Record<ContractSchemaKey, SchemaFixtures> = {
  ...
  "ingested-signal": {
    valid: [
      {
        ...
        receivedAtMs: 1_755_600_000_123,
        signal: {
          schemaVersion: 1,
          id: SIGNAL_ID,
          kind: "danmaku",
          source: "platform-bilibili",
          occurredAt: 1_755_600_000_100,
          priority: 100,
          payload: { text: "你好" },
        },
      },
    ...
    invalid: [
      { schemaVersion: 1, signalId: SIGNAL_ID, sequence: "1", priorityClass: "normal" },
      {
        schemaVersion: 1,
        signalId: SIGNAL_ID,
        sequence: "1",
  ...
  "recent-utterance": {
    valid: [
      { schemaVersion: 1, cycleId: CYCLE_ID, text: "我看看任务进度", purpose: "tool_notice" },
    ],
    invalid: [
      { schemaVersion: 1, cycleId: CYCLE_ID, text: "", purpose: "answer" },
      { schemaVersion: 1, cycleId: CYCLE_ID, text: "x", purpose: "whisper" },
      { schemaVersion: 1, text: "x", purpose: "answer" },
    ],
  },
  "cycle-snapshot": {
    valid: [
      {
        ...
        batch: {
          ...
          watermarkFrom: "1",
          watermarkTo: "3",
          highlights: [{ signalId: SIGNAL_ID, userId: "u1", text: "冲！" }],
          topics: [],
          urgentSignals: [],
          tokenEstimate: 32,
        },
  ...
  "tool-execution-mode": {
    valid: ["parallel_read", "exclusive", "keyed", "background"],
    invalid: ["atomic", "", 1, null],
  },
  "tool-semantic": {
    valid: ["pure", "idempotent", "non_idempotent"],
    invalid: ["idempotent?", "PURE", null],
  },
  "tool-run-state": {
    valid: ["planned", "running", "succeeded", "uncertain"],
    invalid: ["pending", "ok", null],
  },
  "tool-outcome": {
    valid: ["succeeded", "failed", "dependency_failed", "timeout", "cancelled", "denied"],
    invalid: ["uncertain", "skipped", null],
  },
  "tool-cache-source": {
    valid: ["l0", "l1", "l2"],
    invalid: ["l3", "memory", null],
  },
  "tool-result": {
    valid: [
      {
    ...
    invalid: [
      ...
      { schemaVersion: 1, toolRunId: TOOL_RUN_ID, toolName: "x", outcome: "failed" },
      {
        schemaVersion: 1,
        toolRunId: TOOL_RUN_ID,
        toolName: "x",
  ...
  "phase3-signal-ingested-payload": {
    valid: [
      {
        payloadVersion: 1,
        signalId: SIGNAL_ID,
      ...
      { payloadVersion: 1, signalId: SIGNAL_ID, result: "rejected", reason: "queue_full" },
    ],
    invalid: [
      { payloadVersion: 1, signalId: SIGNAL_ID, result: "accepted", sequence: "abc" },
      { payloadVersion: 1, signalId: SIGNAL_ID, result: "queued" },
      { payloadVersion: 2, signalId: SIGNAL_ID, result: "rejected" },
      { payloadVersion: 1, signalId: SIGNAL_ID, result: "rejected", reason: "" },
    ],
  },
  "phase3-batch-sealed-payload": {
    valid: [
      {
        payloadVersion: 1,
  ...
  "phase3-turn-started-payload": {
    valid: [
      {
        payloadVersion: 1,
        turnId: TURN_ID,
        trigger: "normal_batch",
        batchId: "cccccccc-cccc-4ccc-8ccc-cccccccccccc",
      },
      {
        payloadVersion: 1,
  ...
  "phase3-turn-finished-payload": {
    valid: [
      { payloadVersion: 1, turnId: TURN_ID, result: "completed", cycleCount: 2 },
      {
        payloadVersion: 1,
        turnId: TURN_ID,
        result: "degraded",
    ...
    invalid: [
      { payloadVersion: 1, turnId: TURN_ID, result: "paused", cycleCount: 1 },
      { payloadVersion: 1, turnId: TURN_ID, result: "completed", cycleCount: -1 },
    ],
  },
  "phase3-cycle-adopted-payload": {
    valid: [
      {
        payloadVersion: 1,
        turnId: TURN_ID,
      ...
      },
      {
        ...
        degraded: true,
        toolRunIds: [],
        packetDigest: "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
      },
    ],
    invalid: [
      {
      ...
      },
      {
        ...
        degraded: false,
        toolRunIds: [],
        packetDigest: "a".repeat(63),
      },
    ],
  },
  "phase3-cycle-finished-payload": {
    valid: [
      {
        payloadVersion: 1,
        turnId: TURN_ID,
  ...
  "phase3-model-request-payload": {
    valid: [
      ...
      },
      {
        ...
        outcome: "degraded",
        degradationReason: "invalid_packet",
      },
    ],
    invalid: [
      { payloadVersion: 1, cycleId: CYCLE_ID, provider: "", outcome: "final" },
      { payloadVersion: 1, cycleId: CYCLE_ID, provider: "p", outcome: "retried" },
      {
        payloadVersion: 1,
        cycleId: CYCLE_ID,
        provider: "p",
    ...
    valid: [
      {
        ...
        sourceRefs: ["iris:claim:one@2"],
      },
    ],
    invalid: [{ id: "candidate", revision: "02", category: "unknown" }],
  },
  "memory-query": {
    valid: [
      {
    ...
    invalid: [{ schemaVersion: 2, actors: [], topic: "", purpose: "reply" }],
  },
  "context-contribution": {
    ...
    invalid: [{ schemaVersion: 1, providerId: "", blocks: [] }],
  },
  "memory-provider-capabilities": {
    ...
    invalid: [{ schemaVersion: 1, providerVersion: "", mappingVersion: 0 }],
  },
  "memory-observe-event": {
    ...
    invalid: [{ schemaVersion: 1, eventId: "", role: "model", occurredAtMs: -1 }],
  },
  "memory-usage-report": {
    valid: [
      {
        ...
        personaRevision: "1",
        returnedBlockIds: [],
        hostSelectedBlockIds: [],
        modelVisibleBlockIds: [],
        reportedAtMs: 1,
      },
    ],
    invalid: [{ schemaVersion: 1, personaRevision: "-1", reportedAtMs: -1 }],
  },
  "persona-snapshot": {
    valid: [
      {
    ...
    invalid: [{ agentId: "", revision: "01", policyMode: "automatic" }],
  },
  "persona-invalidation": {
    valid: [{ agentId: "agent-1", revision: "2", reason: "revised", cursor: "4" }],
    invalid: [{ agentId: "", reason: "changed" }],
  },
};
