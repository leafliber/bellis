...
> 实施指南：[Phase 3 开发指南](../archive/phase-3/development-guide.md)（含工作包分解与验收标准）\
> 上游基线：[Phase 2 完成态参考](./phase-2.md)\
...
水位单调、非幂等不自动重放等功能不变量由下列测试覆盖；这不等于原计划的性能 P99 已获证明。当前验证入口与剩余项见 [构建与验收状态](../guides/build-and-validation.md)。
